...
ggplot() +
geom_point(data=Period1, aes(x=pctIND_supdrainee_1990, y=log10(Temp_eau_YSI_degC),
 color="P1", shape="P1")) +
geom_smooth(data=Period1, aes(x=pctIND_supdrainee_1990, y=log10(Temp_eau_YSI_degC)),
            
 method=lm, se=FALSE, color="red") +
 geom_point(data=Period2, aes(x=pctIND_supdrainee_2020, y=log10(Temp_eau_YSI_degC ,

color="P2", shape="P2")) +

 geom_smooth(data=Period2, aes(x=pctIND_supdrainee_2020, y=log10(Temp_eau_YSI_degC)),
 method=lm, se=FALSE, color="blue") +
...
labs(title="Relation entre la température et la Zone industriel",

...
```{r Charger_chimie, include=F, message=F, warning=F}
...
```{r Uniformiser_variables, include=F, message=F, warning=F}
...
```{r Station_facteur, include=F, message=F, warning=F}
...
```{r Variable_Station2, include=F, message=F, warning=F}
...
```{r Ordonner_tableau, include=F, message=F, warning=F}
...
```{r Fonctions, include=F, message=F, warning=F}
...
```{r Variable_Date, include=F, message=F, warning=F}
...
```{r Variable_year, include=F, message=F, warning=F}
...
```{r Variable_Period, include=F, message=F, warning=F}
...
```{r Structure_tableau, include=F,  message=F, warning=F}
...
```{r Niveaux, include=F, message=F, warning=F}
...
caract.bv=read.csv2("caract_bv.csv")
dim(caract.bv) # 12 rangées x 319 colonnes
str(caract.bv)
...
# La superficie qui draîne vers la station en fonction de la superficie totale:
...
plot(caract.bv2$sup_km2_sbv, caract.bv2$AGR_km2_supdrainee_2020, pch="", xlim=c(0,120))
text(caract.bv2$sup_km2_sbv, caract.bv2$AGR_km2_supdrainee_2020,  caract.bv2$Station)

plot(caract.bv2$sup_km2_sbv, caract.bv2$IND_km2_supdrainee_2020, pch="", xlim=c(0,120))
text(caract.bv2$sup_km2_sbv, caract.bv2$IND_km2_supdrainee_2020,  caract.bv2$Station)
# Pok-05 se démarque par des superficies plus grande d'industrie par rapport aux autres.

plot(caract.bv2$sup_km2_sbv, caract.bv2$INF_km2_supdrainee_2020, pch="", xlim=c(0,120))
text(caract.bv2$sup_km2_sbv, caract.bv2$INF_km2_supdrainee_2020,  caract.bv2$Station)

plot(caract.bv2$sup_km2_sbv, caract.bv2$SET_km2_supdrainee_2020, pch="", xlim=c(0,120))
text(caract.bv2$sup_km2_sbv, caract.bv2$SET_km2_supdrainee_2020,  caract.bv2$Station)

plot(caract.bv2$sup_km2_sbv, caract.bv2$REC_km2_supdrainee_2020, pch="", xlim=c(0,120))
text(caract.bv2$sup_km2_sbv, caract.bv2$REC_km2_supdrainee_2020,  caract.bv2$Station)
# La variable REC contient beaucoup de zéros.

plot(caract.bv2$sup_km2_sbv, caract.bv2$WIL_km2_supdrainee_2020, pch="", xlim=c(0,120))
text(caract.bv2$sup_km2_sbv, caract.bv2$WIL_km2_supdrainee_2020,  caract.bv2$Station)
...
plot(caract.bv2$sup_km2_sbv, caract.bv2$C_km2_supdrainee_2020, pch="", xlim=c(0,120))
text(caract.bv2$sup_km2_sbv, caract.bv2$C_km2_supdrainee_2020,  caract.bv2$Station)

plot(caract.bv2$sup_km2_sbv, caract.bv2$F_km2_supdrainee_2020, pch="", xlim=c(0,120))
text(caract.bv2$sup_km2_sbv, caract.bv2$F_km2_supdrainee_2020,  caract.bv2$Station)

plot(caract.bv2$sup_km2_sbv, caract.bv2$N_km2_supdrainee_2020, pch="", xlim=c(0,120))
text(caract.bv2$sup_km2_sbv, caract.bv2$N_km2_supdrainee_2020,  caract.bv2$Station)

plot(caract.bv2$sup_km2_sbv, caract.bv2$B_km2_supdrainee_2020, pch="", xlim=c(0,120))
text(caract.bv2$sup_km2_sbv, caract.bv2$B_km2_supdrainee_2020,  caract.bv2$Station)

plot(caract.bv2$sup_km2_sbv, caract.bv2$NULL_km2_supdrainee_2020, pch="", xlim=c(0,120))
text(caract.bv2$sup_km2_sbv, caract.bv2$NULL_km2_supdrainee_2020,  caract.bv2$Station)
...
dim(Pok2001.2022) # 192 x 86
class(Pok2001.2022$Station)
levels(Pok2001.2022$Station)
summary(Pok2001.2022$Station)

dim(caract.bv) # 12 x 319
chimie.bv=merge(Pok2001.2022, caract.bv, by="Station", all=TRUE)
dim(chimie.bv) # 192 x 404
86 + 319 - 1
Pok2001.2022 <- chimie.bv
dim(Pok2001.2022) # 192 x 403

...
```
# Précipitation 2 jours et 21 jours avant et paramètre
...
summary(Pok2001.2022$pctAGR_supdrainee_1990)

subset(Pok2001.2022, Date=="2001-08-01", select = c(Station, sup_km2_sbv, sup_drainee_km2_sbv, AGR_km2_supdrainee_1990, pctAGR_supdrainee_1990))

stem(Pok2001.2022$pctAGR_supdrainee_1990)
...
```{r Coliforme_VS_Précip_2_21_jrs_total}
# Créer un graphique pour l'année 2000
p1 <- ggplot(Pok2001.2022, aes(x=precip.tot.2jours, y=log10(E.coli_MPN_100.mL))) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="red") +
  labs(title="Relation entre les coliformes et la Précipitation 2jrs avant",
       x="precip.tot.2jours",
...
# Pourcentage de l'agriculture_vs_paramètre

```{r Agriculture_vs_Température }
# Créer un graphique pour l'année 1990
p1 <- ggplot(Pok2001.2022, aes(x=pctAGR_supdrainee_1990, y=Temp_eau_YSI_degC)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="red") +
  labs(title="Relation entre Température et l'agriculture en 1990",
       x="pctAGR_supdrainee_1990",
       y="Temp_eau_YSI_degC")
# Créer un graphique pour l'année 2020
p2 <- ggplot(Pok2001.2022, aes(x=pctAGR_supdrainee_2020, y=Temp_eau_YSI_degC)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="blue") +
  labs(title="Relation entre Température et l'agriculture en 2020",
       x="pctAGR_supdrainee_2020",
       y="Temp_eau_YSI_degC")
# Afficher les graphiques
print(p1)
print(p2)
...
## Oxygène_dissous_VS_Agriculture 

```{r Oxygène_dissous_VS_Agriculture}
# Créer un graphique pour l'année 2000
p1 <- ggplot(Pok2001.2022, aes(x=pctAGR_supdrainee_1990, y=Oxyg_dissous_YSI_mg_L)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="red") +
  labs(title="Relation entre l'Oxygène_dissous et l'agriculture en 1990",
       x="pctAGR_supdrainee_1990",
       y="Oxyg_dissous_YSI_mg_L")
# Créer un graphique pour l'année 2020
p2 <- ggplot(Pok2001.2022, aes(x=pctAGR_supdrainee_2020, y=Oxyg_dissous_YSI_mg_L)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="blue") +
  labs(title="Relation entre l'Oxygène_dissous et l'agriculture en 2020",
       x="pctAGR_supdrainee_2020",
       y="Oxyg_dissous_YSI_mg_L")
# Afficher les graphiques
print(p1)
...
## Conductivity_VS_Agriculture

```{r Conductivity_VS_Agriculture}
# Créer un graphique pour l'année 2000
p1 <- ggplot(Pok2001.2022, aes(x=pctAGR_supdrainee_1990, y=Conductivity_microS_cm)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="red") +
  labs(title="Relation entre la Conductivité et l'agriculture en 1990",
       ...
       y="Conductivity_microS_cm")
# Créer un graphique pour l'année 2020
p2 <- ggplot(Pok2001.2022, aes(x=pctAGR_supdrainee_2020, y=Conductivity_microS_cm)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="blue") +
  labs(title="Relation entre la Conductivité et l'agriculture en 2020",
       x="pctAGR_supdrainee_2020",
       y="Conductivity_microS_cm")
# Afficher les graphiques
print(p1)
...
```{r pH_VS_Agriculture}
# Créer un graphique pour l'année 2000
p1 <- ggplot(Pok2001.2022, aes(x=pctAGR_supdrainee_1990, y=pH_units)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="red") +
  labs(title="Relation entre le pH et l'agriculture en 1990",
       ...
       y="pH_units")
# Créer un graphique pour l'année 2020
p2 <- ggplot(Pok2001.2022, aes(x=pctAGR_supdrainee_2020, y=pH_units)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="blue") +
  labs(title="Relation entre le pH et l'agriculture en 2020",
       x="pctAGR_supdrainee_2020",
       y="pH_units")
# Afficher les graphiques
print(p1)
...
## turbidité_VS_Agriculture

```{r turbidité_VS_Agriculture}
# Créer un graphique pour l'année 2000
p1 <- ggplot(Pok2001.2022, aes(x=pctAGR_supdrainee_1990, y=Turbidity_NTU)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="red") +
  labs(title="Relation entre la turbidité et l'agriculture en 1990",
       ...
       y="Turbidity_NTU")
# Créer un graphique pour l'année 2020
p2 <- ggplot(Pok2001.2022, aes(x=pctAGR_supdrainee_2020, y=Turbidity_NTU)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="blue") +
  labs(title="Relation entre la turbidité et l'agriculture en 2020",
       x="pctAGR_supdrainee_2020",
       y="Turbidity_NTU")
# Afficher les graphiques
print(p1)
...
## Couleur_VS_Agriculture

```{r Couleur_VS_Agriculture}
# Créer un graphique pour l'année 2000
p1 <- ggplot(Pok2001.2022, aes(x=pctAGR_supdrainee_1990, y=Colour_TCU)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="red") +
  labs(title="Relation entre la couleur et l'agriculture en 1990",
       ...
       y="Colour_TCU")
# Créer un graphique pour l'année 2020
p2 <- ggplot(Pok2001.2022, aes(x=pctAGR_supdrainee_2020, y=Colour_TCU)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="blue") +
  labs(title="Relation entre la turbidité et l'agriculture en 2020",
       x="pctAGR_supdrainee_2020",
...
```{r COT_VS_Agriculture}
# Créer un graphique pour l'année 2000
p1 <- ggplot(Pok2001.2022, aes(x=pctAGR_supdrainee_1990, y=Carbon_Total_Organic_mg_L)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="red") +
  labs(title="Relation entre le COT et l'agriculture en 1990",
       x="pctAGR_supdrainee_1990",
       y="Carbon_Total_Organic_mg_L")
# Créer un graphique pour l'année 2020
p2 <- ggplot(Pok2001.2022, aes(x=pctAGR_supdrainee_2020, y=Carbon_Total_Organic_mg_L)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="blue") +
  labs(title="Relation entre le COT et l'agriculture en 2020",
       x="pctAGR_supdrainee_2020",
       y="Carbon_Total_Organic_mg_L")
# Afficher les graphiques
print(p1)
...
## Coliforme_VS_Agriculture

```{r Coliforme_VS_Agriculture}
# Créer un graphique pour l'année 2000
p1 <- ggplot(Pok2001.2022, aes(x=pctAGR_supdrainee_1990, y=E.coli_MPN_100.mL)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="red") +
  labs(title="Relation entre les coliformes et l'agriculture en 1990",
       ...
       y="E.coli_MPN_100.mL")
# Créer un graphique pour l'année 2020
p2 <- ggplot(Pok2001.2022, aes(x=pctAGR_supdrainee_2020, y=E.coli_MPN_100.mL)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="blue") +
  labs(title="Relation entre les coliformes et l'agriculture en 2020",
       x="pctAGR_supdrainee_2020",
       y="E.coli_MPN_100.mL")
# Afficher les graphiques
print(p1)
...
## phosphore_VS_Agriculture

```{r phosphore_VS_Agriculture}
# Créer un graphique pour l'année 2000
p1 <- ggplot(Pok2001.2022, aes(x=pctAGR_supdrainee_1990, y=Phosphorus_Total_mg_L)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="red") +
  labs(title="Relation entre le phosphore et l'agriculture en 1990",
       ...
       y="Phosphorus_Total_mg_L")
# Créer un graphique pour l'année 2020
p2 <- ggplot(Pok2001.2022, aes(x=pctAGR_supdrainee_2020, y=Phosphorus_Total_mg_L)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="blue") +
  labs(title="Relation entre le phosphore et l'agriculture en 2020",
       x="pctAGR_supdrainee_2020",
       y="Phosphorus_Total_mg_L")
# Afficher les graphiques
print(p1)
...
## Nitrate_VS_Agriculture

```{r Nitrate_VS_Agriculture}
# Créer un graphique pour l'année 2000
p1 <- ggplot(Pok2001.2022, aes(x=pctAGR_supdrainee_1990, y=Nitrate_as_N_mg_L)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="red") +
  labs(title="Relation entre le nitrate et l'agriculture en 1990",
       x="pctAGR_supdrainee_1990",
       y="Nitrate_as_N_mg_L")
# Créer un graphique pour l'année 2020
p2 <- ggplot(Pok2001.2022, aes(x=pctAGR_supdrainee_2020, y=Nitrate_as_N_mg_L)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="blue") +
  labs(title="Relation entre le nitrate et l'agriculture en 2020",
       x="pctAGR_supdrainee_2020",
       y="Nitrate_as_N_mg_L")
# Afficher les graphiques
print(p1)
...
# Pourcentage de l'infrastructure_vs_paramètre

```{r infrastructure_vs_Température }
# Créer un graphique pour l'année 1990
p1 <- ggplot(Pok2001.2022, aes(x=pctINF_supdrainee_1990, y=Temp_eau_YSI_degC)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="red") +
  labs(title="Relation entre Température et l'infrastructure en 1990",
       x="pctINF_supdrainee_1990",
       y="Temp_eau_YSI_degC")
# Créer un graphique pour l'année 2020
p2 <- ggplot(Pok2001.2022, aes(x=pctINF_supdrainee_2020, y=Temp_eau_YSI_degC)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="blue") +
  labs(title="Relation entre Température et l'infrastructure en 2020",
       x="pctINF_supdrainee_2020",
       y="Temp_eau_YSI_degC")
# Afficher les graphiques
print(p1)
print(p2)
...
## Oxygène_dissous_VS_infrastructure 

```{r Oxygène_dissous_VS_infrastructure}
# Créer un graphique pour l'année 2000
p1 <- ggplot(Pok2001.2022, aes(x=pctINF_supdrainee_1990, y=Oxyg_dissous_YSI_mg_L)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="red") +
  labs(title="Relation entre l'Oxygène_dissous et l'infrastructure en 1990",
       x="pctINF_supdrainee_1990",
       y="Oxyg_dissous_YSI_mg_L")
# Créer un graphique pour l'année 2020
p2 <- ggplot(Pok2001.2022, aes(x=pctINF_supdrainee_2020, y=Oxyg_dissous_YSI_mg_L)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="blue") +
  labs(title="Relation entre l'Oxygène_dissous et l'infrastructure en 2020",
       x="pctINF_supdrainee_2020",
       y="Oxyg_dissous_YSI_mg_L")
# Afficher les graphiques
print(p1)
...
## Conductivity_VS_infrastructure

```{r Conductivity_VS_infrastructure}
# Créer un graphique pour l'année 2000
p1 <- ggplot(Pok2001.2022, aes(x=pctINF_supdrainee_1990, y=Conductivity_microS_cm)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="red") +
  labs(title="Relation entre la Conductivité et l'infrastructure en 1990",
       x="pctINF_supdrainee_1990",
       y="Conductivity_microS_cm")
# Créer un graphique pour l'année 2020
p2 <- ggplot(Pok2001.2022, aes(x=pctINF_supdrainee_2020, y=Conductivity_microS_cm)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="blue") +
  labs(title="Relation entre la Conductivité et l'infrastructure en 2020",
       x="pctINF_supdrainee_2020",
       y="Conductivity_microS_cm")
# Afficher les graphiques
print(p1)
...
## pH_VS_infrastructure

```{r pH_VS_infrastructure}
# Créer un graphique pour l'année 2000
p1 <- ggplot(Pok2001.2022, aes(x=pctINF_supdrainee_1990, y=pH_units)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="red") +
  labs(title="Relation entre le pH et l'infrastructure en 1990",
       x="pctINF_supdrainee_1990",
       y="pH_units")
# Créer un graphique pour l'année 2020
p2 <- ggplot(Pok2001.2022, aes(x=pctINF_supdrainee_2020, y=pH_units)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="blue") +
  labs(title="Relation entre le pH et l'infrastructure en 2020",
       x="pctINF_supdrainee_2020",
       y="pH_units")
# Afficher les graphiques
print(p1)
...
## turbidité_VS_infrastructure

```{r turbidité_VS_infrastructure}
# Créer un graphique pour l'année 2000
p1 <- ggplot(Pok2001.2022, aes(x=pctINF_supdrainee_1990, y=Turbidity_NTU)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="red") +
  labs(title="Relation entre la turbidité et l'infrastructure en 1990",
       x="pctINF_supdrainee_1990",
       y="Turbidity_NTU")
# Créer un graphique pour l'année 2020
p2 <- ggplot(Pok2001.2022, aes(x=pctINF_supdrainee_2020, y=Turbidity_NTU)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="blue") +
  labs(title="Relation entre la turbidité et l'infrastructure en 2020",
       x="pctINF_supdrainee_2020",
       y="Turbidity_NTU")
# Afficher les graphiques
print(p1)
...
## Couleur_VS_infrastructure

```{r Couleur_VS_infrastructure}
# Créer un graphique pour l'année 2000
p1 <- ggplot(Pok2001.2022, aes(x=pctINF_supdrainee_1990, y=Colour_TCU)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="red") +
  labs(title="Relation entre la couleur et l'infrastructure en 1990",
       x="pctINF_supdrainee_1990",
       y="Colour_TCU")
# Créer un graphique pour l'année 2020
p2 <- ggplot(Pok2001.2022, aes(x=pctINF_supdrainee_2020, y=Colour_TCU)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="blue") +
  labs(title="Relation entre la turbidité et l'infrastructure en 2020",
       x="pctINF_supdrainee_2020",
...
## COT_VS_infrastructure

```{r COT_VS_infrastructure}
# Créer un graphique pour l'année 2000
p1 <- ggplot(Pok2001.2022, aes(x=pctINF_supdrainee_1990, y=Carbon_Total_Organic_mg_L)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="red") +
  labs(title="Relation entre le COT et l'infrastructure en 1990",
       x="pctINF_supdrainee_1990",
       y="Carbon_Total_Organic_mg_L")
# Créer un graphique pour l'année 2020
p2 <- ggplot(Pok2001.2022, aes(x=pctINF_supdrainee_2020, y=Carbon_Total_Organic_mg_L)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="blue") +
  labs(title="Relation entre le COT et l'infrastructure en 2020",
       x="pctINF_supdrainee_2020",
       y="Carbon_Total_Organic_mg_L")
# Afficher les graphiques
print(p1)
...
## Coliforme_VS_infrastructure

```{r Coliforme_VS_infrastructure}
# Créer un graphique pour l'année 2000
p1 <- ggplot(Pok2001.2022, aes(x=pctINF_supdrainee_1990, y=E.coli_MPN_100.mL)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="red") +
  labs(title="Relation entre les coliformes et l'infrastructure en 1990",
       x="pctINF_supdrainee_1990",
       y="E.coli_MPN_100.mL")
# Créer un graphique pour l'année 2020
p2 <- ggplot(Pok2001.2022, aes(x=pctINF_supdrainee_2020, y=E.coli_MPN_100.mL)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="blue") +
  labs(title="Relation entre les coliformes et l'infrastructure en 2020",
       x="pctINF_supdrainee_2020",
       y="E.coli_MPN_100.mL")
# Afficher les graphiques
print(p1)
...
## phosphore_VS_infrastructure

```{r phosphore_VS_infrastructure}
# Créer un graphique pour l'année 2000
p1 <- ggplot(Pok2001.2022, aes(x=pctINF_supdrainee_1990, y=Phosphorus_Total_mg_L)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="red") +
  labs(title="Relation entre le phosphore et l'infrastructure en 1990",
       x="pctINF_supdrainee_1990",
       y="Phosphorus_Total_mg_L")
# Créer un graphique pour l'année 2020
p2 <- ggplot(Pok2001.2022, aes(x=pctINF_supdrainee_2020, y=Phosphorus_Total_mg_L)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="blue") +
  labs(title="Relation entre le phosphore et l'infrastructure en 2020",
       x="pctINF_supdrainee_2020",
       y="Phosphorus_Total_mg_L")
# Afficher les graphiques
print(p1)
...
## Nitrate_VS_infrastructure

```{r Nitrate_VS_infrastructure}
# Créer un graphique pour l'année 2000
p1 <- ggplot(Pok2001.2022, aes(x=pctINF_supdrainee_1990, y=Nitrate_as_N_mg_L)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="red") +
  labs(title="Relation entre le nitrate et l'infrastructure en 1990",
       x="pctINF_supdrainee_1990",
       y="Nitrate_as_N_mg_L")
# Créer un graphique pour l'année 2020
p2 <- ggplot(Pok2001.2022, aes(x=pctINF_supdrainee_2020, y=Nitrate_as_N_mg_L)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="blue") +
  labs(title="Relation entre le nitrate et l'infrastructure en 2020",
       x="pctINF_supdrainee_2020",
       y="Nitrate_as_N_mg_L")
# Afficher les graphiques
print(p1)
...
# Pourcentage de superficie d'activités récréatives _vs_paramètre

```{r Récréative_vs_Température }
# Créer un graphique pour l'année 1990
p1 <- ggplot(Pok2001.2022, aes(x=pctREC_supdrainee_1990, y=Temp_eau_YSI_degC)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="red") +
  labs(title="Relation entre Température et l'activités récréatives en 1990",
       x="pctREC_supdrainee_1990",
       y="Temp_eau_YSI_degC")
# Créer un graphique pour l'année 2020
p2 <- ggplot(Pok2001.2022, aes(x=pctREC_supdrainee_2020, y=Temp_eau_YSI_degC)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="blue") +
  labs(title="Relation entre Température et l'activités récréatives en 2020",
       x="pctREC_supdrainee_2020",
       y="Temp_eau_YSI_degC")
# Afficher les graphiques
print(p1)
print(p2)
...
## Oxygène_dissous_VS_Récréative 

```{r Oxygène_dissous_VS_Récréative}
# Créer un graphique pour l'année 2000
p1 <- ggplot(Pok2001.2022, aes(x=pctREC_supdrainee_1990, y=Oxyg_dissous_YSI_mg_L)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="red") +
  labs(title="Relation entre l'Oxygène_dissous et l'activités récréatives en 1990",
       x="pctREC_supdrainee_1990",
       y="Oxyg_dissous_YSI_mg_L")
# Créer un graphique pour l'année 2020
p2 <- ggplot(Pok2001.2022, aes(x=pctREC_supdrainee_2020, y=Oxyg_dissous_YSI_mg_L)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="blue") +
  labs(title="Relation entre l'Oxygène_dissous et l'activités récréatives en 2020",
       x="pctREC_supdrainee_2020",
       y="Oxyg_dissous_YSI_mg_L")
# Afficher les graphiques
print(p1)
...
## Conductivity_VS_Récréative

```{r Conductivity_VS_Récréative}
# Créer un graphique pour l'année 2000
p1 <- ggplot(Pok2001.2022, aes(x=pctREC_supdrainee_1990, y=Conductivity_microS_cm)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="red") +
  labs(title="Relation entre la Conductivité et l'activités récréatives en 1990",
       x="pctREC_supdrainee_1990",
       y="Conductivity_microS_cm")
# Créer un graphique pour l'année 2020
p2 <- ggplot(Pok2001.2022, aes(x=pctREC_supdrainee_2020, y=Conductivity_microS_cm)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="blue") +
  labs(title="Relation entre la Conductivité et l'activités récréatives en 2020",
       x="pctREC_supdrainee_2020",
       y="Conductivity_microS_cm")
# Afficher les graphiques
print(p1)
...
```{r pH_VS_Récréative}
# Créer un graphique pour l'année 2000
p1 <- ggplot(Pok2001.2022, aes(x=pctREC_supdrainee_1990, y=pH_units)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="red") +
  labs(title="Relation entre le pH et l'activités récréatives en 1990",
       x="pctREC_supdrainee_1990",
       y="pH_units")
# Créer un graphique pour l'année 2020
p2 <- ggplot(Pok2001.2022, aes(x=pctREC_supdrainee_2020, y=pH_units)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="blue") +
  labs(title="Relation entre le pH et l'activités récréatives en 2020",
       x="pctREC_supdrainee_2020",
       y="pH_units")
# Afficher les graphiques
print(p1)
...
## turbidité_VS_Récréative

```{r turbidité_VS_Récréative}
# Créer un graphique pour l'année 2000
p1 <- ggplot(Pok2001.2022, aes(x=pctREC_supdrainee_1990, y=Turbidity_NTU)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="red") +
  labs(title="Relation entre la turbidité et l'activités récréatives en 1990",
       x="pctREC_supdrainee_1990",
       y="Turbidity_NTU")
# Créer un graphique pour l'année 2020
p2 <- ggplot(Pok2001.2022, aes(x=pctREC_supdrainee_2020, y=Turbidity_NTU)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="blue") +
  labs(title="Relation entre la turbidité et l'activités récréatives en 2020",
       x="pctREC_supdrainee_2020",
       y="Turbidity_NTU")
# Afficher les graphiques
print(p1)
...
## Couleur_VS_Récréative

```{r Couleur_VS_Récréative}
# Créer un graphique pour l'année 2000
p1 <- ggplot(Pok2001.2022, aes(x=pctREC_supdrainee_1990, y=Colour_TCU)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="red") +
  labs(title="Relation entre la couleur et l'activités récréatives en 1990",
       x="pctREC_supdrainee_1990",
       y="Colour_TCU")
# Créer un graphique pour l'année 2020
p2 <- ggplot(Pok2001.2022, aes(x=pctREC_supdrainee_2020, y=Colour_TCU)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="blue") +
  labs(title="Relation entre la turbidité et l'activités récréatives en 2020",
       x="pctREC_supdrainee_2020",
...
```{r COT_VS_Récréative}
# Créer un graphique pour l'année 2000
p1 <- ggplot(Pok2001.2022, aes(x=pctREC_supdrainee_1990, y=Carbon_Total_Organic_mg_L)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="red") +
  labs(title="Relation entre le COT et l'activités récréatives en 1990",
       x="pctREC_supdrainee_1990",
       y="Carbon_Total_Organic_mg_L")
# Créer un graphique pour l'année 2020
p2 <- ggplot(Pok2001.2022, aes(x=pctREC_supdrainee_2020, y=Carbon_Total_Organic_mg_L)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="blue") +
  labs(title="Relation entre le COT et l'activités récréatives en 2020",
       x="pctREC_supdrainee_2020",
       y="Carbon_Total_Organic_mg_L")
# Afficher les graphiques
print(p1)
...
## Coliforme_VS_Récréative

```{r Coliforme_VS_Récréative}
# Créer un graphique pour l'année 2000
p1 <- ggplot(Pok2001.2022, aes(x=pctREC_supdrainee_1990, y=E.coli_MPN_100.mL)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="red") +
  labs(title="Relation entre les coliformes et l'activités récréatives en 1990",
       x="pctREC_supdrainee_1990",
       y="E.coli_MPN_100.mL")
# Créer un graphique pour l'année 2020
p2 <- ggplot(Pok2001.2022, aes(x=pctREC_supdrainee_2020, y=E.coli_MPN_100.mL)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="blue") +
  labs(title="Relation entre les coliformes et l'activités récréatives en 2020",
       x="pctREC_supdrainee_2020",
       y="E.coli_MPN_100.mL")
# Afficher les graphiques
print(p1)
...
## phosphore_VS_Récréative

```{r phosphore_VS_Récréative}
# Créer un graphique pour l'année 2000
p1 <- ggplot(Pok2001.2022, aes(x=pctREC_supdrainee_1990, y=Phosphorus_Total_mg_L)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="red") +
  labs(title="Relation entre le phosphore et l'activités récréatives en 1990",
       x="pctREC_supdrainee_1990",
       y="Phosphorus_Total_mg_L")
# Créer un graphique pour l'année 2020
p2 <- ggplot(Pok2001.2022, aes(x=pctREC_supdrainee_2020, y=Phosphorus_Total_mg_L)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="blue") +
  labs(title="Relation entre le phosphore et l'activités récréatives en 2020",
       x="pctREC_supdrainee_2020",
       y="Phosphorus_Total_mg_L")
# Afficher les graphiques
print(p1)
...
## Nitrate_VS_Récréative

```{r Nitrate_VS_Récréative}
# Créer un graphique pour l'année 2000
p1 <- ggplot(Pok2001.2022, aes(x=pctREC_supdrainee_1990, y=Nitrate_as_N_mg_L)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="red") +
  labs(title="Relation entre le nitrate et l'activités récréatives en 1990",
       x="pctREC_supdrainee_1990",
       y="Nitrate_as_N_mg_L")
# Créer un graphique pour l'année 2020
p2 <- ggplot(Pok2001.2022, aes(x=pctREC_supdrainee_2020, y=Nitrate_as_N_mg_L)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="blue") +
  labs(title="Relation entre le nitrate et l'activités récréatives en 2020",
       x="pctREC_supdrainee_2020",
       y="Nitrate_as_N_mg_L")
# Afficher les graphiques
print(p1)
...
# Pourcentage de zones_urbaines _vs_paramètre

```{r zones_urbaines_vs_Température }
# Créer un graphique pour l'année 1990
p1 <- ggplot(Pok2001.2022, aes(x=pctSET_supdrainee_1990, y=Temp_eau_YSI_degC)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="red") +
  labs(title="Relation entre Température et les zones urbaines en 1990",
       x="pctSET_supdrainee_1990",
       y="Temp_eau_YSI_degC")
# Créer un graphique pour l'année 2020
p2 <- ggplot(Pok2001.2022, aes(x=pctSET_supdrainee_2020, y=Temp_eau_YSI_degC)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="blue") +
  labs(title="Relation entre Température et les zones urbaines en 2020",
       x="pctSET_supdrainee_2020",
       y="Temp_eau_YSI_degC")
# Afficher les graphiques
print(p1)
print(p2)
...
## Oxygène_dissous_VS_zones_urbaines

```{r Oxygène_dissous_VS_zones_urbaines}
# Créer un graphique pour l'année 2000
p1 <- ggplot(Pok2001.2022, aes(x=pctSET_supdrainee_1990, y=Oxyg_dissous_YSI_mg_L)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="red") +
  labs(title="Relation entre l'Oxygène_dissous et les zones urbaines en 1990",
       x="pctSET_supdrainee_1990",
       y="Oxyg_dissous_YSI_mg_L")
# Créer un graphique pour l'année 2020
p2 <- ggplot(Pok2001.2022, aes(x=pctSET_supdrainee_2020, y=Oxyg_dissous_YSI_mg_L)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="blue") +
  labs(title="Relation entre l'Oxygène_dissous et les zones urbaines en 2020",
       x="pctSET_supdrainee_2020",
       y="Oxyg_dissous_YSI_mg_L")
# Afficher les graphiques
print(p1)
...
## Conductivity_VS_zones_urbaines

```{r Conductivity_VS_zones_urbaines}
# Créer un graphique pour l'année 2000
p1 <- ggplot(Pok2001.2022, aes(x=pctSET_supdrainee_1990, y=Conductivity_microS_cm)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="red") +
  labs(title="Relation entre la Conductivité et les zones urbaines en 1990",
       x="pctSET_supdrainee_1990",
       y="Conductivity_microS_cm")
# Créer un graphique pour l'année 2020
p2 <- ggplot(Pok2001.2022, aes(x=pctSET_supdrainee_2020, y=Conductivity_microS_cm)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="blue") +
  labs(title="Relation entre la Conductivité et les zones urbaines en 2020",
       x="pctSET_supdrainee_2020",
       y="Conductivity_microS_cm")
# Afficher les graphiques
print(p1)
...
## pH_VS_zones_urbaines

```{r pH_VS_zones_urbaines}
# Créer un graphique pour l'année 2000
p1 <- ggplot(Pok2001.2022, aes(x=pctSET_supdrainee_1990, y=pH_units)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="red") +
  labs(title="Relation entre le pH et les zones urbaines en 1990",
       x="pctSET_supdrainee_1990",
       y="pH_units")
# Créer un graphique pour l'année 2020
p2 <- ggplot(Pok2001.2022, aes(x=pctSET_supdrainee_2020, y=pH_units)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="blue") +
  labs(title="Relation entre le pH et les zones urbaines en 2020",
       x="pctSET_supdrainee_2020",
       y="pH_units")
# Afficher les graphiques
print(p1)
...
## turbidité_VS_zones_urbaines

```{r turbidité_VS_zones_urbaines}
# Créer un graphique pour l'année 2000
p1 <- ggplot(Pok2001.2022, aes(x=pctSET_supdrainee_1990, y=Turbidity_NTU)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="red") +
  labs(title="Relation entre la turbidité et les zones urbaines en 1990",
       x="pctSET_supdrainee_1990",
       y="Turbidity_NTU")
# Créer un graphique pour l'année 2020
p2 <- ggplot(Pok2001.2022, aes(x=pctSET_supdrainee_2020, y=Turbidity_NTU)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="blue") +
  labs(title="Relation entre la turbidité et les zones urbaines en 2020",
       x="pctSET_supdrainee_2020",
       y="Turbidity_NTU")
# Afficher les graphiques
print(p1)
...
## Couleur_VS_zones_urbaines

```{r Couleur_VS_zones_urbaines}
# Créer un graphique pour l'année 2000
p1 <- ggplot(Pok2001.2022, aes(x=pctSET_supdrainee_1990, y=Colour_TCU)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="red") +
  labs(title="Relation entre la couleur et les zones urbaines en 1990",
       x="pctSET_supdrainee_1990",
       y="Colour_TCU")
# Créer un graphique pour l'année 2020
p2 <- ggplot(Pok2001.2022, aes(x=pctSET_supdrainee_2020, y=Colour_TCU)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="blue") +
  labs(title="Relation entre la turbidité et les zones urbaines en 2020",
       x="pctSET_supdrainee_2020",
...
## COT_VS_zones_urbaines

```{r COT_VS_zones_urbaines}
# Créer un graphique pour l'année 2000
p1 <- ggplot(Pok2001.2022, aes(x=pctSET_supdrainee_1990, y=Carbon_Total_Organic_mg_L)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="red") +
  labs(title="Relation entre le COT et les zones urbaines en 1990",
       x="pctSET_supdrainee_1990",
       y="Carbon_Total_Organic_mg_L")
# Créer un graphique pour l'année 2020
p2 <- ggplot(Pok2001.2022, aes(x=pctSET_supdrainee_2020, y=Carbon_Total_Organic_mg_L)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="blue") +
  labs(title="Relation entre le COT et les zones urbaines en 2020",
       x="pctSET_supdrainee_2020",
       y="Carbon_Total_Organic_mg_L")
# Afficher les graphiques
print(p1)
...
## Coliforme_VS_zones_urbaines

```{r Coliforme_VS_zones_urbaines}
# Créer un graphique pour l'année 2000
p1 <- ggplot(Pok2001.2022, aes(x=pctSET_supdrainee_1990, y=E.coli_MPN_100.mL)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="red") +
  labs(title="Relation entre les coliformes et les zones urbaines en 1990",
       x="pctSET_supdrainee_1990",
       y="E.coli_MPN_100.mL")
# Créer un graphique pour l'année 2020
p2 <- ggplot(Pok2001.2022, aes(x=pctSET_supdrainee_2020, y=E.coli_MPN_100.mL)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="blue") +
  labs(title="Relation entre les coliformes et les zones urbaines en 2020",
       x="pctSET_supdrainee_2020",
       y="E.coli_MPN_100.mL")
# Afficher les graphiques
print(p1)
...
## phosphore_VS_zones_urbaines

```{r phosphore_VS_zones_urbaines}
# Créer un graphique pour l'année 2000
p1 <- ggplot(Pok2001.2022, aes(x=pctSET_supdrainee_1990, y=Phosphorus_Total_mg_L)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="red") +
  labs(title="Relation entre le phosphore et les zones urbaines en 1990",
       x="pctSET_supdrainee_1990",
       y="Phosphorus_Total_mg_L")
# Créer un graphique pour l'année 2020
p2 <- ggplot(Pok2001.2022, aes(x=pctSET_supdrainee_2020, y=Phosphorus_Total_mg_L)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="blue") +
  labs(title="Relation entre le phosphore et les zones urbaines en 2020",
       x="pctSET_supdrainee_2020",
       y="Phosphorus_Total_mg_L")
# Afficher les graphiques
print(p1)
...
## Nitrate_VS_zones_urbaines

```{r Nitrate_VS_zones_urbaines}
# Créer un graphique pour l'année 2000
p1 <- ggplot(Pok2001.2022, aes(x=pctSET_supdrainee_1990, y=Nitrate_as_N_mg_L)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="red") +
  labs(title="Relation entre le nitrate et les zones urbaines en 1990",
       x="pctSET_supdrainee_1990",
       y="Nitrate_as_N_mg_L")
# Créer un graphique pour l'année 2020
p2 <- ggplot(Pok2001.2022, aes(x=pctSET_supdrainee_2020, y=Nitrate_as_N_mg_L)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="blue") +
  labs(title="Relation entre le nitrate et les zones urbaines en 2020",
       x="pctSET_supdrainee_2020",
       y="Nitrate_as_N_mg_L")
# Afficher les graphiques
print(p1)
...
# Pourcentage de zones_sans_anthropisations_vs_paramètre

```{r zones_sans_anthropisations_vs_Température }
# Créer un graphique pour l'année 1990
p1 <- ggplot(Pok2001.2022, aes(x=pctWIL_supdrainee_1990, y=Temp_eau_YSI_degC)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="red") +
  labs(title="Relation entre Température et les zones urbaines en 1990",
       x="pctWIL_supdrainee_1990",
       y="Temp_eau_YSI_degC")
# Créer un graphique pour l'année 2020
p2 <- ggplot(Pok2001.2022, aes(x=pctWIL_km2_supdrainee_2020, y=Temp_eau_YSI_degC)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="blue") +
  labs(title="Relation entre Température et les zones urbaines en 2020",
       x="pctWIL_km2_supdrainee_2020",
       y="Temp_eau_YSI_degC")
# Afficher les graphiques
print(p1)
print(p2)
...
## Oxygène_dissous_VS_zones_sans_anthropisations

```{r Oxygène_dissous_VS_zones_sans_anthropisations}
# Créer un graphique pour l'année 2000
p1 <- ggplot(Pok2001.2022, aes(x=pctWIL_supdrainee_1990, y=Oxyg_dissous_YSI_mg_L)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="red") +
  labs(title="Relation entre l'Oxygène_dissous et les zones urbaines en 1990",
       x="pctWIL_supdrainee_1990",
       y="Oxyg_dissous_YSI_mg_L")
# Créer un graphique pour l'année 2020
p2 <- ggplot(Pok2001.2022, aes(x=pctWIL_supdrainee_2020, y=Oxyg_dissous_YSI_mg_L)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="blue") +
  labs(title="Relation entre l'Oxygène_dissous et les zones urbaines en 2020",
       x="pctWIL_supdrainee_2020",
       y="Oxyg_dissous_YSI_mg_L")
# Afficher les graphiques
print(p1)
print(p2)
...
## Conductivity_VS_zones_sans_anthropisations

```{r Conductivity_VS_zones_sans_anthropisations}
# Créer un graphique pour l'année 2000
p1 <- ggplot(Pok2001.2022, aes(x=pctWIL_supdrainee_1990, y=Conductivity_microS_cm)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="red") +
  labs(title="Relation entre la Conductivité et les zones urbaines en 1990",
       x="pctWIL_supdrainee_1990",
       y="Conductivity_microS_cm")
# Créer un graphique pour l'année 2020
p2 <- ggplot(Pok2001.2022, aes(x=pctWIL_supdrainee_2020, y=Conductivity_microS_cm)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="blue") +
  labs(title="Relation entre la Conductivité et les zones urbaines en 2020",
       x="pctWIL_supdrainee_2020",
...
## pH_VS_zones_sans_anthropisations

```{r pH_VS_zones_sans_anthropisations}
# Créer un graphique pour l'année 2000
p1 <- ggplot(Pok2001.2022, aes(x=pctWIL_supdrainee_1990, y=pH_units)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="red") +
  labs(title="Relation entre le pH et les zones urbaines en 1990",
       x="pctWIL_supdrainee_1990",
       y="pH_units")
# Créer un graphique pour l'année 2020
p2 <- ggplot(Pok2001.2022, aes(x=pctWIL_supdrainee_2020, y=pH_units)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="blue") +
  labs(title="Relation entre le pH et les zones urbaines en 2020",
       x="pctWIL_supdrainee_2020",
...
## turbidité_VS_zones_sans_anthropisations

```{r turbidité_VS_zones_sans_anthropisations}
# Créer un graphique pour l'année 2000
p1 <- ggplot(Pok2001.2022, aes(x=pctWIL_supdrainee_1990, y=Turbidity_NTU)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="red") +
  labs(title="Relation entre la turbidité et les zones urbaines en 1990",
       x="pctWIL_supdrainee_1990",
       y="Turbidity_NTU")
# Créer un graphique pour l'année 2020
p2 <- ggplot(Pok2001.2022, aes(x=pctWIL_supdrainee_2020, y=Turbidity_NTU)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="blue") +
  labs(title="Relation entre la turbidité et les zones urbaines en 2020",
       x="pctWIL_supdrainee_2020",
...
## Couleur_VS_zones_sans_anthropisations

```{r Couleur_VS_zones_sans_anthropisations}
# Créer un graphique pour l'année 2000
p1 <- ggplot(Pok2001.2022, aes(x=pctWIL_supdrainee_1990, y=Colour_TCU)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="red") +
  labs(title="Relation entre la couleur et les zones urbaines en 1990",
       x="pctWIL_supdrainee_1990",
       y="Colour_TCU")
# Créer un graphique pour l'année 2020
p2 <- ggplot(Pok2001.2022, aes(x=pctWIL_supdrainee_2020, y=Colour_TCU)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="blue") +
  labs(title="Relation entre la turbidité et les zones urbaines en 2020",
       x="pctWIL_supdrainee_2020",
...
## COT_VS_zones_sans_anthropisations

```{r COT_VS_zones_sans_anthropisations}
# Créer un graphique pour l'année 2000
p1 <- ggplot(Pok2001.2022, aes(x=pctWIL_supdrainee_1990, y=Carbon_Total_Organic_mg_L)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="red") +
  labs(title="Relation entre le COT et les zones urbaines en 1990",
       x="pctWIL_supdrainee_1990",
       y="Carbon_Total_Organic_mg_L")
# Créer un graphique pour l'année 2020
p2 <- ggplot(Pok2001.2022, aes(x=pctWIL_supdrainee_2020, y=Carbon_Total_Organic_mg_L)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="blue") +
  labs(title="Relation entre le COT et les zones urbaines en 2020",
       x="pctWIL_supdrainee_2020",
...
## Coliforme_VS_zones_sans_anthropisations

```{r Coliforme_VS_zones_sans_anthropisations}
# Créer un graphique pour l'année 2000
p1 <- ggplot(Pok2001.2022, aes(x=pctWIL_supdrainee_1990, y=E.coli_MPN_100.mL)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="red") +
  labs(title="Relation entre les coliformes et les zones urbaines en 1990",
       x="pctWIL_supdrainee_1990",
       y="E.coli_MPN_100.mL")
# Créer un graphique pour l'année 2020
p2 <- ggplot(Pok2001.2022, aes(x=pctWIL_supdrainee_2020, y=E.coli_MPN_100.mL)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="blue") +
  labs(title="Relation entre les coliformes et les zones urbaines en 2020",
       x="pctWIL_supdrainee_2020",
...
## phosphore_VS_zones_sans_anthropisations

```{r phosphore_VS_zones_sans_anthropisations}
# Créer un graphique pour l'année 2000
p1 <- ggplot(Pok2001.2022, aes(x=pctWIL_supdrainee_1990, y=Phosphorus_Total_mg_L)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="red") +
  labs(title="Relation entre le phosphore et les zones urbaines en 1990",
       x="pctWIL_supdrainee_1990",
       y="Phosphorus_Total_mg_L")
# Créer un graphique pour l'année 2020
p2 <- ggplot(Pok2001.2022, aes(x=pctWIL_supdrainee_2020, y=Phosphorus_Total_mg_L)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="blue") +
  labs(title="Relation entre le phosphore et les zones urbaines en 2020",
       x="pctWIL_supdrainee_2020",
...
## Nitrate_VS_zones_sans_anthropisations

```{r Nitrate_VS_zones_sans_anthropisations}
# Créer un graphique pour l'année 2000
p1 <- ggplot(Pok2001.2022, aes(x=pctWIL_supdrainee_1990, y=Nitrate_as_N_mg_L)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="red") +
  labs(title="Relation entre le nitrate et les zones urbaines en 1990",
       x="pctWIL_supdrainee_1990",
       y="Nitrate_as_N_mg_L")
# Créer un graphique pour l'année 2020
p2 <- ggplot(Pok2001.2022, aes(x=pctWIL_supdrainee_2020, y=Nitrate_as_N_mg_L)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE, color="blue") +
  labs(title="Relation entre le nitrate et les zones urbaines en 2020",
       x="pctWIL_supdrainee_2020",

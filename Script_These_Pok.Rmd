...
```{r Zone_industriel_vs_Conductivité}
...
# Coupeablanc_vs_Turbidité 

```{r Coupeablanc_vs_Turbidité }
...
# AP 2024-06-13 Essayer l'option "fig.cap" ci-dessus, ici et partout.
# Température variabilité spatiale
ggplot(aes(y=precip_tot_mm, x= Period), data=Pok2001.2022) + geom_boxplot() +
  theme(axis.text.x = element_text(angle = 45, hjust=1),axis.text=element_text(size=12),
        axis.title=element_text(size=14,face="bold"))+
...
# AP 2024-06-13 Essayer l'option "fig.cap" ci-dessus, ici et partout.
# Température variabilité spatiale
ggplot(aes(y=precip.tot.2jours, x= Period), data=Pok2001.2022) + geom_boxplot() +
  theme(axis.text.x = element_text(angle = 45, hjust=1),axis.text=element_text(size=12),
        axis.title=element_text(size=14,face="bold"))+
  ggtitle("Variation  de la pluies à 20ans entre les deux Period")
```
...
# AP 2024-06-13 Essayer l'option "fig.cap" ci-dessus, ici et partout.
# Température variabilité spatiale
ggplot(aes(y=precip.tot.3jours, x= Period), data=Pok2001.2022) + geom_boxplot() +
  theme(axis.text.x = element_text(angle = 45, hjust=1),axis.text=element_text(size=12),
        axis.title=element_text(size=14,face="bold"))+
  ggtitle("Variation  de la pluies à 20ans entre les deux Period")
```
...
# AP 2024-06-13 Essayer l'option "fig.cap" ci-dessus, ici et partout.
# Température variabilité spatiale
ggplot(aes(y=precip.tot.4jours , x= Period), data=Pok2001.2022) + geom_boxplot() +
  theme(axis.text.x = element_text(angle = 45, hjust=1),axis.text=element_text(size=12),
        axis.title=element_text(size=14,face="bold"))+
  ggtitle("Variation  de la pluies à 20ans entre les deux Period")
```
...
# AP 2024-06-13 Essayer l'option "fig.cap" ci-dessus, ici et partout.
# Température variabilité spatiale
ggplot(aes(y=precip.tot.5jours, x= Period), data=Pok2001.2022) + geom_boxplot() +
  theme(axis.text.x = element_text(angle = 45, hjust=1),axis.text=element_text(size=12),
        axis.title=element_text(size=14,face="bold"))+
  ggtitle("Variation  de la pluies à 20ans entre les deux Period")
```
...
# AP 2024-06-13 Essayer l'option "fig.cap" ci-dessus, ici et partout.
# Température variabilité spatiale
ggplot(aes(y=precip.tot.6jours, x= Period), data=Pok2001.2022) + geom_boxplot() +
  theme(axis.text.x = element_text(angle = 45, hjust=1),axis.text=element_text(size=12),
        axis.title=element_text(size=14,face="bold"))+
  ggtitle("Variation  de la pluies à 20ans entre les deux Period")
```
...
# AP 2024-06-13 Essayer l'option "fig.cap" ci-dessus, ici et partout.
# Température variabilité spatiale
ggplot(aes(y=precip.tot.7jours , x= Period), data=Pok2001.2022) + geom_boxplot() +
  theme(axis.text.x = element_text(angle = 45, hjust=1),axis.text=element_text(size=12),
        axis.title=element_text(size=14,face="bold"))+
  ggtitle("Variation  de la pluies à 20ans entre les deux Period")
```
...
# AP 2024-06-13 Essayer l'option "fig.cap" ci-dessus, ici et partout.
# Température variabilité spatiale
ggplot(aes(y=precip.tot.14jours, x= Period), data=Pok2001.2022) + geom_boxplot() +
  theme(axis.text.x = element_text(angle = 45, hjust=1),axis.text=element_text(size=12),
        axis.title=element_text(size=14,face="bold"))+
  ggtitle("Variation  de la pluies à 20ans entre les deux Period")
```
...
# AP 2024-06-13 Essayer l'option "fig.cap" ci-dessus, ici et partout.
# Température variabilité spatiale
ggplot(aes(y=precip.tot.21jours, x= Period), data=Pok2001.2022) + geom_boxplot() +
  theme(axis.text.x = element_text(angle = 45, hjust=1),axis.text=element_text(size=12),
        axis.title=element_text(size=14,face="bold"))+
  ggtitle("Variation  de la pluies à 20ans entre les deux Period")
```
...
# AP 2024-06-13 Essayer l'option "fig.cap" ci-dessus, ici et partout.
# Température variabilité spatiale
ggplot(aes(y=Tmax2jours, x= Period), data=Pok2001.2022) + geom_boxplot() +
  theme(axis.text.x = element_text(angle = 45, hjust=1),axis.text=element_text(size=12),
        axis.title=element_text(size=14,face="bold"))+
  ggtitle("Variation  de la pluies à 20ans entre les deux Period")
```
...
# AP 2024-06-13 Essayer l'option "fig.cap" ci-dessus, ici et partout.
# Température variabilité spatiale
ggplot(aes(y=Tmax3jours, x= Period), data=Pok2001.2022) + geom_boxplot() +
  theme(axis.text.x = element_text(angle = 45, hjust=1),axis.text=element_text(size=12),
        axis.title=element_text(size=14,face="bold"))+
  ggtitle("Variation  de la pluies à 20ans entre les deux Period")
```
...
# AP 2024-06-13 Essayer l'option "fig.cap" ci-dessus, ici et partout.
# Température variabilité spatiale
ggplot(aes(y=Tmax4jours, x= Period), data=Pok2001.2022) + geom_boxplot() +
  theme(axis.text.x = element_text(angle = 45, hjust=1),axis.text=element_text(size=12),
        axis.title=element_text(size=14,face="bold"))+
  ggtitle("Variation  de la pluies à 20ans entre les deux Period")
```
...
# AP 2024-06-13 Essayer l'option "fig.cap" ci-dessus, ici et partout.
# Température variabilité spatiale
ggplot(aes(y=Tmax5jours , x= Period), data=Pok2001.2022) + geom_boxplot() +
  theme(axis.text.x = element_text(angle = 45, hjust=1),axis.text=element_text(size=12),
        axis.title=element_text(size=14,face="bold"))+
  ggtitle("Variation  de la pluies à 20ans entre les deux Period")
```
...
# AP 2024-06-13 Essayer l'option "fig.cap" ci-dessus, ici et partout.
# Température variabilité spatiale
ggplot(aes(y=Tmax6jours, x= Period), data=Pok2001.2022) + geom_boxplot() +
  theme(axis.text.x = element_text(angle = 45, hjust=1),axis.text=element_text(size=12),
        axis.title=element_text(size=14,face="bold"))+
  ggtitle("Variation  de la pluies à 20ans entre les deux Period")
```
...
# AP 2024-06-13 Essayer l'option "fig.cap" ci-dessus, ici et partout.
# Température variabilité spatiale
ggplot(aes(y=Tmax7jours, x= Period), data=Pok2001.2022) + geom_boxplot() +
  theme(axis.text.x = element_text(angle = 45, hjust=1),axis.text=element_text(size=12),
        axis.title=element_text(size=14,face="bold"))+
  ggtitle("Variation  de la pluies à 20ans entre les deux Period")
```
...
# AP 2024-06-13 Essayer l'option "fig.cap" ci-dessus, ici et partout.
# Température variabilité spatiale
ggplot(aes(y=Tmin2jours, x= Period), data=Pok2001.2022) + geom_boxplot() +
  theme(axis.text.x = element_text(angle = 45, hjust=1),axis.text=element_text(size=12),
        axis.title=element_text(size=14,face="bold"))+
  ggtitle("Variation  de la pluies à 20ans entre les deux Period")
```
...
# AP 2024-06-13 Essayer l'option "fig.cap" ci-dessus, ici et partout.
# Température variabilité spatiale
ggplot(aes(y=Tmin3jours , x= Period), data=Pok2001.2022) + geom_boxplot() +
  theme(axis.text.x = element_text(angle = 45, hjust=1),axis.text=element_text(size=12),
        axis.title=element_text(size=14,face="bold"))+
  ggtitle("Variation  de la pluies à 20ans entre les deux Period")
```
...
# AP 2024-06-13 Essayer l'option "fig.cap" ci-dessus, ici et partout.
# Température variabilité spatiale
ggplot(aes(y=Tmin4jours , x= Period), data=Pok2001.2022) + geom_boxplot() +
  theme(axis.text.x = element_text(angle = 45, hjust=1),axis.text=element_text(size=12),
        axis.title=element_text(size=14,face="bold"))+
  ggtitle("Variation  de la pluies à 20ans entre les deux Period")
```
...
# AP 2024-06-13 Essayer l'option "fig.cap" ci-dessus, ici et partout.
# Température variabilité spatiale
ggplot(aes(y=Tmin5jours , x= Period), data=Pok2001.2022) + geom_boxplot() +
  theme(axis.text.x = element_text(angle = 45, hjust=1),axis.text=element_text(size=12),
        axis.title=element_text(size=14,face="bold"))+
  ggtitle("Variation  de la pluies à 20ans entre les deux Period")
```
...
# AP 2024-06-13 Essayer l'option "fig.cap" ci-dessus, ici et partout.
# Température variabilité spatiale
ggplot(aes(y=Tmin6jours , x= Period), data=Pok2001.2022) + geom_boxplot() +
  theme(axis.text.x = element_text(angle = 45, hjust=1),axis.text=element_text(size=12),
        axis.title=element_text(size=14,face="bold"))+
  ggtitle("Variation  de la pluies à 20ans entre les deux Period")
```
...
# AP 2024-06-13 Essayer l'option "fig.cap" ci-dessus, ici et partout.
# Température variabilité spatiale
ggplot(aes(y=Tmin7jours , x= Period), data=Pok2001.2022) + geom_boxplot() +
  theme(axis.text.x = element_text(angle = 45, hjust=1),axis.text=element_text(size=12),
        axis.title=element_text(size=14,face="bold"))+
  ggtitle("Variation  de la pluies à 20ans entre les deux Period")
```

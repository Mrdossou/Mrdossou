...
# setwd("C:/Users/mrdos/OneDrive/Documents/Shippagan_mai_aout_2024/Analyse_R_sum/Github_Pr")
...
# M	Mining	2015	Mine
# G	Windthrow	2015	Chablis (oui, il y a bien deux codes pour le chablis). 
...
```{r Tableaux_2001_etc,  include=F, message=F, warning=F}
...
scatterplot(Pok2001.2022$Ordre3_m_amont,Pok2001.2022$Colour_TCU,   
              groups=Pok2001.2022$Year, smooth=F, by.groups=F, regLine=T,)

scatterplot(Colour_TCU~Ordre3_m_amont | Year,  
...
De : Gaël Cidoine Vignon Bayo Dossou <egd8301@umoncton.ca>
Envoyé : 15 juillet 2024 14:30
À : Alain Patoine <alain.patoine@umoncton.ca>
Objet : Code pour la relation entre les paramètres et les facteurs du territoires

 

```{r Agriculture_vs_Temperature, eval=F}
...
### ctree pour Gaël 2024-07-16


De : Alain Patoine
Envoyé : 16 juillet 2024 09:24
À : Gaël Cidoine Vignon Bayo Dossou <egd8301@umoncton.ca>
Objet : Présentation de la fonction d'arbre de régression ctree
 
Bonjour Gaël,

Voici un bloc de code pour les arbres de régression. Tu peux le copier dans ton script et l'exécuter. Revois les notes du cours que tu as suivi avec Gaétan. On s'en reparle.
...
# Créer une variable Non-Forest (en km2 de la superficie draînée) qui présente
# les valeurs de 1990 pour les rangées de 1990 et les valeurs de 2020 pour les 
# rangées de 2020

# Textuellement: "si la période est 2001-2002 alors 2001-2002, autrement 2021-2022
Pok2001.2022$NF_km2_supdrainee=ifelse(Pok2001.2022$Period=="2001-2002",Pok2001.2022$NF_km2_supdrainee_1990,Pok2001.2022$NF_km2_supdrainee_2020)

# Vérifier que la procédure a bien fonctionné:
subset(Pok2001.2022,select=c(Period,NF_km2_supdrainee_1990,
                             NF_km2_supdrainee_2020, NF_km2_supdrainee))

# Créer la variable "universelle" pctNF_supdrainee 
# en utilisant la variable précédemment créée.
Pok2001.2022$pctNF_supdrainee = Pok2001.2022$NF_km2_supdrainee/Pok2001.2022$sup_drainee_km2_sbv

# Vérifier que les valeurs ont du sens
subset(Pok2001.2022,select=c(Station, Date, NF_km2_supdrainee, 
                             sup_drainee_km2_sbv, pctNF_supdrainee))
1.11/19.21
# 0.057 (5,7%)
...
# Et voilà. Tu peux adapter le code ci-dessus pour créer des variables
# "universelles" de AGR, INF, etc.
```
